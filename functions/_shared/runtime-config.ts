...
export const getRuntimeConfig = (env: Env) => ({
  ...
  growthMaxBatchesPerInvocation: integerSetting(env.GROWTH_MAX_BATCHES_PER_INVOCATION, 12, 1, 96),
  growthInvocationBudgetMs: integerSetting(env.GROWTH_INVOCATION_BUDGET_MS, 45_000, 5_000, 120_000),
  growthProfileConcurrency: integerSetting(env.GROWTH_PROFILE_CONCURRENCY, 1, 1, 8),
  growthClaimLeaseSeconds: integerSetting(env.GROWTH_CLAIM_LEASE_SECONDS, 600, 60, 900),
  growthNewProfile24hLimit: integerSetting(env.GROWTH_NEW_PROFILE_24H_LIMIT, 12, 1, 10_000),
  growthPendingProfileLimit: integerSetting(env.GROWTH_PENDING_PROFILE_LIMIT, 8, 1, 10_000),
