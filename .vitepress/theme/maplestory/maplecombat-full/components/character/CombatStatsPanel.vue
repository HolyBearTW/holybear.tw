  ...
  <div class="calc-layout">
    <div class="calc-main">
      ...
      <div class="section stat-table-card">
        <slot name="head" />
        <ContextGuide title="先看：請照遊戲「來源顯示」填入" open tone="warning">
          <ul>
            <li>在遊戲開啟「詳細屬性」，把滑鼠移到 LUK、DEX、攻擊力等數字，查看「來源顯示」。</li>
            <li>將「套用中的數值」最上方的「基本數值／% 數值／% 未套用數值」，逐欄填到同名欄位；不要填最外層的 72,313 這類面板總值。</li>
            <li>來源顯示下方若有「技能」數值或百分比，另外填進同一列的「技能・消耗」；飛鏢、箭矢與彈丸不計入。</li>
            <li>Nexon API 沒有回傳這組完整拆分。重新帶入只更新能精確讀取的裝備等資料，不會再用本站來源分析小計覆蓋你依遊戲填好的數字。</li>
          </ul>
        </ContextGuide>
      ...
      <div class="section stat-table-card">
        ...
        <p class="holybear-field-note">
          武器總攻擊請填「含星火、不含潛能」的總值；多個活動 Buff 要相加。萌獸每條終傷會先逐條加總，再依遊戲的單精度規則計算。
        </p>
        <div class="stat-table stat-table--bonus">
          <div class="st-row">
            <span class="st-row-group-title">武器、寵物與常駐能力</span>
          ...
          <div class="st-row">
            <span class="st-row-group-title">活動 Buff</span>
            <div class="st-cell">
          ...
          <div class="st-row">
            <span class="st-row-group-title">結界與師徒</span>
            <div class="st-cell">
