...
#maplestory-root .maple-manual-ad-bottom .maple-container-responsive-ad > .maple-manual-ad {
  width: min(672px, 100%);
  margin-inline: auto;
}

#maplestory-root .maple-manual-ad-bottom .maple-container-responsive-ad > .maple-manual-ad-fixed {
  width: 1200px;
  max-width: none;
}
