export const updateLogs = [  
  { date: '2026/08/22', content: '改善戰力工具的淺色模式、導航操作與載入動畫；AI 健檢新增近期 Gemini、GPT 模型與尤比太判定，遇到忙碌或無回應時會自動改用備選模型，也同步更新燦爛的凶星與靈魂寶珠規則。角色查詢、排名、成長紀錄與核心塔運作更順暢；經驗趨勢和升級預估現在不必建立成長檔案也能查看，裝備提示也會分色顯示星火、卷軸與星力加成。' },
