export const updateLogs = [  
  { date: '2026/08/21', content: '強化戰力工具與角色成長功能：修正惡魔復仇者能力雷達圖誤將 STR 當成主屬性的問題，現在會依職業正確顯示 HP，並套用專屬視覺尺度，避免 HP 數值量級較大造成雷達圖過度放大；近期戰力排名新增翻頁、指定頁次查詢及角色目前排名確認；新增成長檔案建立與同步進度，以及近一年經驗趨勢、升級預估時間、成長概覽、年度成長日曆與角色成長大事記；新增聯盟攻擊隊區塊，可切換預設 1～5，查看聯盟棋盤、攻擊隊員、佔領加成與成員加成；同時改善搜尋與日期控制、近期排行榜、更新日誌、手機版間距及深淺色介面，更新日誌亦新增每頁五筆與指定頁次功能。' },
