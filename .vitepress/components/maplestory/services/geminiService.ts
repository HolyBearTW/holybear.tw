...
// UPDATE: 預設值改為 gemini-3.1-flash-lite
export const analyzeCharacter = async (data: DashboardData, apiKey: string, modelId: string = 'gemini-3.1-flash-lite', ignoreWarnings: boolean = false, onProgress?: (msg: string) => void): Promise<string> => {
  if (!apiKey) {
