export default [
  ...
  },
  {
    ...
    items: [
      ...
      { text: '停用特定功能 (Disabling)', link: '/docs/Telegram-Rose-Bot#停用特定功能-disabling' },
      { text: '聯盟系統 (Federations)', link: '/docs/Telegram-Rose-Bot#聯盟系統-federations' },
      { text: '關鍵字自動回覆 (Filters)', link: '/docs/Telegram-Rose-Bot#關鍵字自動回覆-filters' },
      { text: '訊息格式化 (Formatting)', link: '/docs/Telegram-Rose-Bot#訊息格式化-formatting' },
